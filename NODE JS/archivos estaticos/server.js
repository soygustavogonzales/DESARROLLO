...
function ejecutar(){
	function onRequest(req,res){
		...
		switch(extension){
			...
			break;
			case '.eot':
			tipoContenido='Application/font-eot';
			break;
			case '.svg':
			tipoContenido='Application/font-svg';
			break;
			case '.woff':
			tipoContenido='Application/font-woff';
			break;
			case '.ttf':
			tipoContenido='Application/font-ttf';
			break;
			case '.otf':
			tipoContenido='Application/font-otf';
			break;
