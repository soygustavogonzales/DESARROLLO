...
<body>
	...
	var obj1=new net.exeAJAX(),oParametros={},form1=window.f,elements=form1.elements,element=null;
	...
	boton.addEventListener('click',function(){
		...
		for(var i= elements.length-1;i>=0;i--){
			...
			if(!element.dataset){
				element.dataset={};
				element.dataset.parameter=eval(element.getAttribute('data-parameter'));
			}
