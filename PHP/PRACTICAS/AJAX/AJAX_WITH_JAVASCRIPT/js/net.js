				...
				,Pedir:function(options){
						if(typeof(options)=="object"){
							var defaults ={
								method:'POST'
								,pathFile:'null'
								,queryString:{query:'null',dataType:'null'}
								,asincronus:true
							...
							if(Object.prototype.toString.call(this.options.fallback)=="[object Function]"){
								console.log(this.options.fallback);
					...
					queryString=this.options.queryString.query,//un objeto o null en si defecto
					dataType=this.options.queryString.dataType,//una cadena o null en su defecto
					...
					if(queryString==undefined){
						...
						switch(dataType){
							case 'JSON':
								queryString="query="+JSON.stringify(queryString);
							break;
							case null:
								var cad="";
